...
namespace BlackEyesMvc.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,OrderTime,CustomerId,ProductId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,OrderTime,CustomerId,ProductId")] Order order)
        {
            if (ModelState.IsValid)
            {
